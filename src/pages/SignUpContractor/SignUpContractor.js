...
import { loginApi, ContractorRegisterApi, getUserDetails } from "../../services/request";
                ...
                >
                    ...
                    >
                        <Grid container spacing={2}>
                            <Grid item xs={12}>
                                <Typography className={classes.signInText}>Contractor Sign Up</Typography>
                            </Grid>
                            <Grid item xs={12}>
                                <Formik
                                    initialValues={{
                                    ...
                                    onSubmit={(values, { setSubmitting, resetForm }) => {
                                        console.log(values);
                                        ContractorRegisterApi(values)
                                            .then((res) => {
                                                console.log(res)
                                                if (res.data.status) {
                                                    // let id = res?.data?.data?._id;
                                                    ShowSnackbar("success", "Contractor Registered Successfully");
                                                    history.push("/login");
                                                } else {
